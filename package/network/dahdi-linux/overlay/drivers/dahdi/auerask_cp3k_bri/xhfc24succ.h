...
#define R_CIRM 0x00 // register access
    ...
    {
        REGWORD reg;
        bit_r_cirm bit_value;
    }reg_r_cirm; // register and bitmap access
...
#define R_CTRL 0x01 // register access
	...
	typedef union {REGWORD reg; bit_r_ctrl bit_value;} reg_r_ctrl; // register and bitmap access
...
#define R_CLK_CFG 0x02 // register access
	...
	typedef union {REGWORD reg; bit_r_clk_cfg bit_value;} reg_r_clk_cfg; // register and bitmap access
...
#define A_Z1 0x04 // register access
	...
	typedef union {REGWORD reg; bit_a_z1 bit_value;} reg_a_z1; // register and bitmap access
...
#define A_Z2 0x06 // register access
	...
	typedef union {REGWORD reg; bit_a_z2 bit_value;} reg_a_z2; // register and bitmap access
...
#define R_RAM_ADDR 0x08 // register access
	...
	typedef union {REGWORD reg; bit_r_ram_addr bit_value;} reg_r_ram_addr; // register and bitmap access
...
#define R_RAM_CTRL 0x09 // register access
	...
	typedef union {REGWORD reg; bit_r_ram_ctrl bit_value;} reg_r_ram_ctrl; // register and bitmap access
...
#define R_FIRST_FIFO 0x0B // register access
	...
	typedef union {REGWORD reg; bit_r_first_fifo bit_value;} reg_r_first_fifo; // register and bitmap access
...
#define R_FIFO_THRES 0x0C // register access
	...
	typedef union {REGWORD reg; bit_r_fifo_thres bit_value;} reg_r_fifo_thres; // register and bitmap access
...
#define A_F1 0x0C // register access
	...
	typedef union {REGWORD reg; bit_a_f1 bit_value;} reg_a_f1; // register and bitmap access
...
#define R_FIFO_MD 0x0D // register access
	...
	typedef union {REGWORD reg; bit_r_fifo_md bit_value;} reg_r_fifo_md; // register and bitmap access
...
#define A_F2 0x0D // register access
	...
	typedef union {REGWORD reg; bit_a_f2 bit_value;} reg_a_f2; // register and bitmap access
...
#define A_INC_RES_FIFO 0x0E // register access
	...
	typedef union {REGWORD reg; bit_a_inc_res_fifo bit_value;} reg_a_inc_res_fifo; // register and bitmap access
...
#define A_FIFO_STA 0x0E // register access
	...
	typedef union {REGWORD reg; bit_a_fifo_sta bit_value;} reg_a_fifo_sta; // register and bitmap access
...
#define R_FSM_IDX 0x0F // register access
	...
	typedef union {REGWORD reg; bit_r_fsm_idx bit_value;} reg_r_fsm_idx; // register and bitmap access


#define FIFO_SIZE           256     // Gr� in Byte der FIFOs
...
#define R_FIFO 0x0F // register access
	...
	typedef union {REGWORD reg; bit_r_fifo bit_value;} reg_r_fifo; // register and bitmap access
...
#define R_SLOT 0x10 // register access
	...
	typedef union {REGWORD reg; bit_r_slot bit_value;} reg_r_slot; // register and bitmap access
...
#define R_IRQ_OVIEW 0x10 // register access
	...
	typedef union {REGWORD reg; bit_r_irq_oview bit_value;} reg_r_irq_oview; // register and bitmap access
...
#define R_MISC_IRQMSK 0x11 // register access
	...
	typedef union {REGWORD reg; bit_r_misc_irqmsk bit_value;} reg_r_misc_irqmsk; // register and bitmap access
...
#define R_MISC_IRQ 0x11 // register access
	...
	typedef union {REGWORD reg; bit_r_misc_irq bit_value;} reg_r_misc_irq; // register and bitmap access
...
#define R_SU_IRQ 0x12 // register access
	...
	typedef union {REGWORD reg; bit_r_su_irq bit_value;} reg_r_su_irq; // register and bitmap access
...
#define R_SU_IRQMSK 0x12 // register access
	...
	typedef union {REGWORD reg; bit_r_su_irqmsk bit_value;} reg_r_su_irqmsk; // register and bitmap access
...
#define R_AF0_OVIEW 0x13 // register access
	...
	typedef union {REGWORD reg; bit_r_af0_oview bit_value;} reg_r_af0_oview; // register and bitmap access
...
#define R_IRQ_CTRL 0x13 // register access
	...
	typedef union {REGWORD reg; bit_r_irq_ctrl bit_value;} reg_r_irq_ctrl; // register and bitmap access
...
#define A_USAGE 0x14 // register access
	...
	typedef union {REGWORD reg; bit_a_usage bit_value;} reg_a_usage; // register and bitmap access
...
#define R_PCM_MD0 0x14 // register access
	...
	typedef union {REGWORD reg; bit_r_pcm_md0 bit_value;} reg_r_pcm_md0; // register and bitmap access
...
#define R_SL_SEL0 0x15 // register access
	...
	typedef union {REGWORD reg; bit_r_sl_sel0 bit_value;} reg_r_sl_sel0; // register and bitmap access
...
#define R_SL_SEL1 0x15 // register access
	...
	typedef union {REGWORD reg; bit_r_sl_sel1 bit_value;} reg_r_sl_sel1; // register and bitmap access
...
#define R_SL_SEL7 0x15 // register access
	...
	typedef union {REGWORD reg; bit_r_sl_sel7 bit_value;} reg_r_sl_sel7; // register and bitmap access
...
#define R_MSS0 0x15 // register access
	...
	typedef union {REGWORD reg; bit_r_mss0 bit_value;} reg_r_mss0; // register and bitmap access
...
#define R_PCM_MD1 0x15 // register access
	...
	typedef union {REGWORD reg; bit_r_pcm_md1 bit_value;} reg_r_pcm_md1; // register and bitmap access
...
#define R_PCM_MD2 0x15 // register access
	...
	typedef union {REGWORD reg; bit_r_pcm_md2 bit_value;} reg_r_pcm_md2; // register and bitmap access
...
#define R_MSS1 0x15 // register access
	...
	typedef union {REGWORD reg; bit_r_mss1 bit_value;} reg_r_mss1; // register and bitmap access
...
#define R_SH0L 0x15 // register access
	...
	typedef union {REGWORD reg; bit_r_sh0l bit_value;} reg_r_sh0l; // register and bitmap access
...
#define R_SH0H 0x15 // register access
	...
	typedef union {REGWORD reg; bit_r_sh0h bit_value;} reg_r_sh0h; // register and bitmap access
...
#define R_SH1L 0x15 // register access
	...
	typedef union {REGWORD reg; bit_r_sh1l bit_value;} reg_r_sh1l; // register and bitmap access
...
#define R_SH1H 0x15 // register access
	...
	typedef union {REGWORD reg; bit_r_sh1h bit_value;} reg_r_sh1h; // register and bitmap access
...
#define R_RAM_USE 0x15 // register access
	...
	typedef union {REGWORD reg; bit_r_ram_use bit_value;} reg_r_ram_use; // register and bitmap access
...
#define R_SU_SEL 0x16 // register access
	...
	typedef union {REGWORD reg; bit_r_su_sel bit_value;} reg_r_su_sel; // register and bitmap access
...
#define R_CHIP_ID 0x16 // register access
	...
	typedef union {REGWORD reg; bit_r_chip_id bit_value;} reg_r_chip_id; // register and bitmap access
...
#define R_SU_SYNC 0x17 // register access
	...
	typedef union {REGWORD reg; bit_r_su_sync bit_value;} reg_r_su_sync; // register and bitmap access
...
#define R_BERT_STA 0x17 // register access
	...
	typedef union {REGWORD reg; bit_r_bert_sta bit_value;} reg_r_bert_sta; // register and bitmap access
...
#define R_F0_CNTL 0x18 // register access
	...
	typedef union {REGWORD reg; bit_r_f0_cntl bit_value;} reg_r_f0_cntl; // register and bitmap access
...
#define R_F0_CNTH 0x19 // register access
	...
	typedef union {REGWORD reg; bit_r_f0_cnth bit_value;} reg_r_f0_cnth; // register and bitmap access
...
#define R_BERT_ECL 0x1A // register access
	...
	typedef union {REGWORD reg; bit_r_bert_ecl bit_value;} reg_r_bert_ecl; // register and bitmap access
...
#define R_TI_WD 0x1A // register access
	...
	typedef union {REGWORD reg; bit_r_ti_wd bit_value;} reg_r_ti_wd; // register and bitmap access
...
#define R_BERT_ECH 0x1B // register access
	...
	typedef union {REGWORD reg; bit_r_bert_ech bit_value;} reg_r_bert_ech; // register and bitmap access
...
#define R_BERT_WD_MD 0x1B // register access
	...
	typedef union {REGWORD reg; bit_r_bert_wd_md bit_value;} reg_r_bert_wd_md; // register and bitmap access
...
#define R_STATUS 0x1C // register access
	...
	typedef union {REGWORD reg; bit_r_status bit_value;} reg_r_status; // register and bitmap access
...
#define R_SL_MAX 0x1D // register access
	...
	typedef union {REGWORD reg; bit_r_sl_max bit_value;} reg_r_sl_max; // register and bitmap access
...
#define R_PWM_CFG 0x1E // register access
	...
	typedef union {REGWORD reg; bit_r_pwm_cfg bit_value;} reg_r_pwm_cfg; // register and bitmap access
...
#define R_CHIP_RV 0x1F // register access
	...
	typedef union {REGWORD reg; bit_r_chip_rv bit_value;} reg_r_chip_rv; // register and bitmap access
...
#define R_FIFO_BL0_IRQ 0x20 // register access
	...
	typedef union {REGWORD reg; bit_r_fifo_bl0_irq bit_value;} reg_r_fifo_bl0_irq; // register and bitmap access
...
#define R_FIFO_BL1_IRQ 0x21 // register access
	...
	typedef union {REGWORD reg; bit_r_fifo_bl1_irq bit_value;} reg_r_fifo_bl1_irq; // register and bitmap access
...
#define R_FIFO_BL2_IRQ 0x22 // register access
	...
	typedef union {REGWORD reg; bit_r_fifo_bl2_irq bit_value;} reg_r_fifo_bl2_irq; // register and bitmap access
...
#define R_FIFO_BL3_IRQ 0x23 // register access
	...
	typedef union {REGWORD reg; bit_r_fifo_bl3_irq bit_value;} reg_r_fifo_bl3_irq; // register and bitmap access
...
#define R_FILL_BL0 0x24 // register access
	...
	typedef union {REGWORD reg; bit_r_fill_bl0 bit_value;} reg_r_fill_bl0; // register and bitmap access
...
#define R_FILL_BL1 0x25 // register access
	...
	typedef union {REGWORD reg; bit_r_fill_bl1 bit_value;} reg_r_fill_bl1; // register and bitmap access
...
#define R_FILL_BL2 0x26 // register access
	...
	typedef union {REGWORD reg; bit_r_fill_bl2 bit_value;} reg_r_fill_bl2; // register and bitmap access
...
#define R_FILL_BL3 0x27 // register access
	...
	typedef union {REGWORD reg; bit_r_fill_bl3 bit_value;} reg_r_fill_bl3; // register and bitmap access
...
#define R_CI_TX 0x28 // register access
	...
	typedef union {REGWORD reg; bit_r_ci_tx bit_value;} reg_r_ci_tx; // register and bitmap access
...
#define R_CI_RX 0x28 // register access
	...
	typedef union {REGWORD reg; bit_r_ci_rx bit_value;} reg_r_ci_rx; // register and bitmap access
...
#define R_GCI_CFG0 0x29 // register access
	...
	typedef union {REGWORD reg; bit_r_gci_cfg0 bit_value;} reg_r_gci_cfg0; // register and bitmap access
...
#define R_GCI_STA 0x29 // register access
	...
	typedef union {REGWORD reg; bit_r_gci_sta bit_value;} reg_r_gci_sta; // register and bitmap access
...
#define R_GCI_CFG1 0x2A // register access
	...
	typedef union {REGWORD reg; bit_r_gci_cfg1 bit_value;} reg_r_gci_cfg1; // register and bitmap access
...
#define R_MON_RX 0x2A // register access
	...
	typedef union {REGWORD reg; bit_r_mon_rx bit_value;} reg_r_mon_rx; // register and bitmap access
...
#define R_MON_TX 0x2B // register access
	...
	typedef union {REGWORD reg; bit_r_mon_tx bit_value;} reg_r_mon_tx; // register and bitmap access
...
#define A_SU_WR_STA 0x30 // register access
    ...
    #define L1_ACTIVATION   3
    #define L1_DEACTIVATION 2
	...
	typedef union {REGWORD reg; bit_a_su_wr_sta bit_value;} reg_a_su_wr_sta; // register and bitmap access
...
#define A_SU_RD_STA 0x30 // register access
	...
	typedef union {REGWORD reg; bit_a_su_rd_sta bit_value;} reg_a_su_rd_sta; // register and bitmap access
...
#define A_SU_CTRL0 0x31 // register access
	...
	typedef union {REGWORD reg; bit_a_su_ctrl0 bit_value;} reg_a_su_ctrl0; // register and bitmap access

#define V_B1_TX_EN          0x01    // Bit 0: 1 -> B1 send data enabled
#define V_B1_TX_DIS         0x00    // Bit 0: 0 -> B1 send data disabled
#define V_B2_TX_EN          0x02    // Bit 1: 1 -> B2 send data enabled
#define V_B2_TX_DIS         0x00    // Bit 1: 0 -> B2 send data disabled
#define V_SU_MD_NT          0x04    // Bit 2: 1 -> NT/LT mode
#define V_SU_MD_TE          0x00    // Bit 2: 0 -> TE mode
#define V_ST_D_LPRIO_HIGH   0x00    // Bit 3: 0 -> high priority 8/9
#define V_ST_SQ_EN          0x00    // Bit 4: 0 -> S/Q bits disabled
#define V_SU_TST_SIG        0x00    // Bit 5: 0 -> normal operation
#define V_ST_TX_LI          0x40    // Bit 6: 0 -> capacitive line mode
#define V_SU_STOP           0x00    // Bit 7: 0 -> external receiver activated

#define SU_CTRL0_BIT2_7     (  V_SU_MD_TE           /* Bit 2: '0' TE mode                   */  \
                             | V_ST_D_LPRIO_HIGH    /* Bit 3: '0' high priority 8/9         */  \
                             | V_ST_SQ_EN           /* Bit 4: '0' S/Q bit disable           */  \
                             | V_SU_TST_SIG         /* Bit 5: '0' normal operation          */  \
                             | V_ST_TX_LI           /* Bit 6: '1' non capacitive line mode  */  \
                             | V_SU_STOP )          // Bit 7: '0' normal operation, oscillator active
...
#define A_SU_DLYL 0x31 // register access
	...
	typedef union {REGWORD reg; bit_a_su_dlyl bit_value;} reg_a_su_dlyl; // register and bitmap access
...
#define A_SU_CTRL1 0x32 // register access
	...
	typedef union {REGWORD reg; bit_a_su_ctrl1 bit_value;} reg_a_su_ctrl1; // register and bitmap access
...
#define A_SU_DLYH 0x32 // register access
	...
	typedef union {REGWORD reg; bit_a_su_dlyh bit_value;} reg_a_su_dlyh; // register and bitmap access
...
#define A_SU_CTRL2 0x33 // register access
	...
	typedef union {REGWORD reg; bit_a_su_ctrl2 bit_value;} reg_a_su_ctrl2; // register and bitmap access

#define V_B1_RX_EN          0x01    // Bit 0: 1 -> B1 receive data enabled
#define V_B1_RX_DIS         0x00    // Bit 0: 0 -> B1 receive data disabled
#define V_B2_RX_EN          0x02    // Bit 1: 1 -> B2 receive data enabled
#define V_B2_RX_DIS         0x00    // Bit 1: 0 -> B2 receive data disabled
#define V_MS_SSYNC2         0x00    // Bit 2: 0 -> for multiframe
#define V_BAC_S_SEL         0x00    // Bit 3: 0 -> for multiframe
#define V_SU_SYNC_NT        0x00    // Bit 4: 0 -> for NT-mode
#define V_SU_2KHZ           0x00    // Bit 5: 0 -> test signal frequency
#define V_SU_TRI            0x00    // Bit 6: 0 -> normal operation
#define V_SU_NORMP          0x00    // Bit 7: 0 -> Normale Polaritt
#define V_SU_EXCHG          0x80    // Bit 7: 1 -> Exchange polarity of the line interface output pins!

#define SU_CTRL2_BIT2_7     (  V_MS_SSYNC2          /* Bit 2: 0 -> for multiframe           */  \
                             | V_BAC_S_SEL          /* Bit 3: 0 -> for multiframe           */  \
                             | V_SU_SYNC_NT         /* Bit 4: 0 -> for NT-mode              */  \
                             | V_SU_2KHZ            /* Bit 5: 0 -> test signal frequency    */  \
                             | V_SU_TRI             /* Bit 6: 0 -> normal operation         */  \
                             | V_SU_NORMP )         /* Bit 7: 0 -> Normale Polaritt        */
...
#define A_MS_TX 0x34 // register access
	...
	typedef union {REGWORD reg; bit_a_ms_tx bit_value;} reg_a_ms_tx; // register and bitmap access
...
#define A_MS_RX 0x34 // register access
	...
	typedef union {REGWORD reg; bit_a_ms_rx bit_value;} reg_a_ms_rx; // register and bitmap access
...
#define A_ST_CTRL3 0x35 // register access
	...
	typedef union {REGWORD reg; bit_a_st_ctrl3 bit_value;} reg_a_st_ctrl3; // register and bitmap access
...
#define A_UP_CTRL3 0x35 // register access
	...
	typedef union {REGWORD reg; bit_a_up_ctrl3 bit_value;} reg_a_up_ctrl3; // register and bitmap access
...
#define A_SU_STA 0x35 // register access
	...
	typedef union {REGWORD reg; bit_a_su_sta bit_value;} reg_a_su_sta; // register and bitmap access
...
#define A_MS_DF 0x36 // register access
	...
	typedef union {REGWORD reg; bit_a_ms_df bit_value;} reg_a_ms_df; // register and bitmap access
...
#define A_SU_CLK_DLY 0x37 // register access
	...
	typedef union {REGWORD reg; bit_a_su_clk_dly bit_value;} reg_a_su_clk_dly; // register and bitmap access
...
#define R_PWM0 0x38 // register access
	...
	typedef union {REGWORD reg; bit_r_pwm0 bit_value;} reg_r_pwm0; // register and bitmap access
...
#define R_PWM1 0x39 // register access
	...
	typedef union {REGWORD reg; bit_r_pwm1 bit_value;} reg_r_pwm1; // register and bitmap access
...
#define A_B1_TX 0x3C // register access
	...
	typedef union {REGWORD reg; bit_a_b1_tx bit_value;} reg_a_b1_tx; // register and bitmap access
...
#define A_B1_RX 0x3C // register access
	...
	typedef union {REGWORD reg; bit_a_b1_rx bit_value;} reg_a_b1_rx; // register and bitmap access
...
#define A_B2_TX 0x3D // register access
	...
	typedef union {REGWORD reg; bit_a_b2_tx bit_value;} reg_a_b2_tx; // register and bitmap access
...
#define A_B2_RX 0x3D // register access
	...
	typedef union {REGWORD reg; bit_a_b2_rx bit_value;} reg_a_b2_rx; // register and bitmap access
...
#define A_D_TX 0x3E // register access
	...
	typedef union {REGWORD reg; bit_a_d_tx bit_value;} reg_a_d_tx; // register and bitmap access
...
#define A_D_RX 0x3E // register access
	...
	typedef union {REGWORD reg; bit_a_d_rx bit_value;} reg_a_d_rx; // register and bitmap access
...
#define A_E_RX 0x3F // register access
	...
	typedef union {REGWORD reg; bit_a_e_rx bit_value;} reg_a_e_rx; // register and bitmap access
...
#define A_BAC_S_TX 0x3F // register access
	...
	typedef union {REGWORD reg; bit_a_bac_s_tx bit_value;} reg_a_bac_s_tx; // register and bitmap access
...
#define R_GPIO_OUT1 0x40 // register access
	...
	typedef union {REGWORD reg; bit_r_gpio_out1 bit_value;} reg_r_gpio_out1; // register and bitmap access
...
#define R_GPIO_IN1 0x40 // register access
	...
	typedef union {REGWORD reg; bit_r_gpio_in1 bit_value;} reg_r_gpio_in1; // register and bitmap access
...
#define R_GPIO_OUT3 0x41 // register access
	...
	typedef union {REGWORD reg; bit_r_gpio_out3 bit_value;} reg_r_gpio_out3; // register and bitmap access
...
#define R_GPIO_IN3 0x41 // register access
	...
	typedef union {REGWORD reg; bit_r_gpio_in3 bit_value;} reg_r_gpio_in3; // register and bitmap access
...
#define R_GPIO_EN1 0x42 // register access
	...
	typedef union {REGWORD reg; bit_r_gpio_en1 bit_value;} reg_r_gpio_en1; // register and bitmap access
...
#define R_GPIO_EN3 0x43 // register access
	...
	typedef union {REGWORD reg; bit_r_gpio_en3 bit_value;} reg_r_gpio_en3; // register and bitmap access
...
#define R_GPIO_SEL_BL 0x44 // register access
	...
	typedef union {REGWORD reg; bit_r_gpio_sel_bl bit_value;} reg_r_gpio_sel_bl; // register and bitmap access
...
#define R_GPIO_OUT2 0x45 // register access
	...
	typedef union {REGWORD reg; bit_r_gpio_out2 bit_value;} reg_r_gpio_out2; // register and bitmap access
...
#define R_GPIO_IN2 0x45 // register access
	...
	typedef union {REGWORD reg; bit_r_gpio_in2 bit_value;} reg_r_gpio_in2; // register and bitmap access
...
#define R_PWM_MD 0x46 // register access
	...
	typedef union {REGWORD reg; bit_r_pwm_md bit_value;} reg_r_pwm_md; // register and bitmap access
...
#define R_GPIO_EN2 0x47 // register access
	...
	typedef union {REGWORD reg; bit_r_gpio_en2 bit_value;} reg_r_gpio_en2; // register and bitmap access
...
#define R_GPIO_IN0 0x48 // register access
	...
	typedef union {REGWORD reg; bit_r_gpio_in0 bit_value;} reg_r_gpio_in0; // register and bitmap access
...
#define R_GPIO_OUT0 0x48 // register access
	...
	typedef union {REGWORD reg; bit_r_gpio_out0 bit_value;} reg_r_gpio_out0; // register and bitmap access
...
#define R_GPIO_EN0 0x4A // register access
	...
	typedef union {REGWORD reg; bit_r_gpio_en0 bit_value;} reg_r_gpio_en0; // register and bitmap access
...
#define R_GPIO_SEL 0x4C // register access
	...
	typedef union {REGWORD reg; bit_r_gpio_sel bit_value;} reg_r_gpio_sel; // register and bitmap access
...
#define R_PLL_STA 0x50 // register access
	...
	typedef union {REGWORD reg; bit_r_pll_sta bit_value;} reg_r_pll_sta; // register and bitmap access
...
#define R_PLL_CTRL 0x50 // register access
	...
	typedef union {REGWORD reg; bit_r_pll_ctrl bit_value;} reg_r_pll_ctrl; // register and bitmap access
...
#define R_PLL_P 0x51 // register access
	...
	typedef union {REGWORD reg; bit_r_pll_p bit_value;} reg_r_pll_p; // register and bitmap access
...
#define R_PLL_N 0x52 // register access
	...
	typedef union {REGWORD reg; bit_r_pll_n bit_value;} reg_r_pll_n; // register and bitmap access
...
#define R_PLL_S 0x53 // register access
	...
	typedef union {REGWORD reg; bit_r_pll_s bit_value;} reg_r_pll_s; // register and bitmap access
...
#define A_FIFO_DATA 0x80 // register access
	...
	typedef union {REGWORD reg; bit_a_fifo_data bit_value;} reg_a_fifo_data; // register and bitmap access
...
#define A_FIFO_DATA_NOINC 0x84 // register access
	...
	typedef union {REGWORD reg; bit_a_fifo_data_noinc bit_value;} reg_a_fifo_data_noinc; // register and bitmap access
...
#define R_INT_DATA 0x88 // register access
	...
	typedef union {REGWORD reg; bit_r_int_data bit_value;} reg_r_int_data; // register and bitmap access
...
#define R_RAM_DATA 0xC0 // register access
	...
	typedef union {REGWORD reg; bit_r_ram_data bit_value;} reg_r_ram_data; // register and bitmap access
...
#define A_SL_CFG 0xD0 // register access
	...
	typedef union {REGWORD reg; bit_a_sl_cfg bit_value;} reg_a_sl_cfg; // register and bitmap access
...
#define A_CH_MSK 0xF4 // register access
	...
	typedef union {REGWORD reg; bit_a_ch_msk bit_value;} reg_a_ch_msk; // register and bitmap access
...
#define A_CON_HDLC 0xFA // register access
	...
	typedef union {REGWORD reg; bit_a_con_hdlc bit_value;} reg_a_con_hdlc; // register and bitmap access

// page 138
#define DATA_TX_FIFO_TO_LI  0   // FIFO -> ST/UP
#define DATA_TX_FIFO_TO_PCM 2   // FIFO -> PCM
#define DATA_TX_LI_TO_FIFO  6   // ST/UP -> FIFO

#define DATA_RX_LI_TO_FIFO  0   // ST/UP -> FIFO
#define DATA_RX_PCM_TO_FIFO 1   // PCM -> FIFO
#define DATA_RX_PCM_TO_LI   7   // PCM -> ST/UP
...
#define A_SUBCH_CFG 0xFB // register access
	...
	typedef union {REGWORD reg; bit_a_subch_cfg bit_value;} reg_a_subch_cfg; // register and bitmap access
...
#define A_CHANNEL 0xFC // register access
	...
	typedef union {REGWORD reg; bit_a_channel bit_value;} reg_a_channel; // register and bitmap access
...
#define A_FIFO_SEQ 0xFD // register access
	...
	typedef union {REGWORD reg; bit_a_fifo_seq bit_value;} reg_a_fifo_seq; // register and bitmap access
...
#define A_FIFO_CTRL 0xFF // register access
	...
	typedef union {REGWORD reg; bit_a_fifo_ctrl bit_value;} reg_a_fifo_ctrl; // register and bitmap access
